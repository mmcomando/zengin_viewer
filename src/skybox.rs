...
// Step 1 Insert Resource and loada skybox texture
...
// Step 2 Make 2d skybox texture be 3d texture
...
// Step 3 when skybox texture is ready add skybox component to camera
